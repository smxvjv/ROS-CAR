...
- 隔离测试节点全部干净退出。完整语音脚本已手动切到默认 ROS 域 182，唤醒串口、ASR、路由、DeepSeek、TTS 五节点已启动。用户真人唤醒后，IAT 识别“你是人类吗？”，DeepSeek 回答“不是，我是跑在 ROS 2 小车上的语音助手，不算人类”，TTS 播放 178668 字节 PCM，回答已追加到 JSONL；该次人耳听感仍待用户确认。没有启动蜂鸣器 GPIO、底盘或灯光节点，也未设置开机自启动。
